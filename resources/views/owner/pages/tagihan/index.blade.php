        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    You can manage all Tagihan, such as editing, deleting and more.
                </p>
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($tagihan as $tagih)
                                            <tr>
                                                <td>{{ $tagih->user ? $tagih->user->name : 'Unknown' }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href='{{ route('tagihan.edit', $tagih->id) }}'
                                                            class="btn btn-sm btn-info btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                            Edit
                                                        </a>

                                                        <form action="{{ route('tagihan.destroy', $tagih->id) }}"
